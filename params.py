...
class Parameters():
    def __init__(self):
        self.n_processors = 8
        # Path
        self.data_dir =  'C:/Users/Omar/Documents/Tarecda/aisg-sla/data/'
        self.image_dir = self.data_dir + '/train/'
        self.pose_dir = self.data_dir + '/pose_GT/'

        self.train_video = ['1', '2', '3', '4', '5']
        self.valid_video = ['6', '7', '8', '9']
        ...
        self.record_path = 'C:/Users/Omar/Documents/Tarecda/aisg-sla/data/records/t{}_v{}_im{}x{}_s{}x{}_b{}_rnn{}_{}.txt'.format(
        ...
        self.save_model_path = 'C:/Users/Omar/Documents/Tarecda/aisg-sla/data/models/t{}_v{}_im{}x{}_s{}x{}_b{}_rnn{}_{}.model'.format(
            ''.join(self.train_video),
            ''.join(self.valid_video),
            self.img_h,
            self.img_w,
        ...
        self.save_optimzer_path = 'C:/Users/Omar/Documents/Tarecda/aisg-sla/data/models/t{}_v{}_im{}x{}_s{}x{}_b{}_rnn{}_{}.optimizer'.format(
            ''.join(self.train_video),
            ''.join(self.valid_video),
            self.img_h,
            self.img_w,
